...
#using the default database for heroku
...
SECRET_KEY = 'bfy2*j5=eeash*+js2du657ivo*a2_x=g-$%$mqtma_83^s!b2'
...
INSTALLED_APPS = (
    ...
    'rtwilio',
    'recharge',
    #"rapidsms.contrib.handlers",#repeat
...
INSTALLED_BACKENDS = {
    ...
    "twilio-backend": {
        ...
        'config': {
            'account_sid': 'ACd247c78d30b514c59d47182fa1d05599',  # (required)
            'auth_token': '6cfe9195ab7ae7912bfbaec09b7a5aea',  # (required)
            'number': '337-419-3222',  # your Twilio phone number (required)
...
RAPIDSMS_HANDLERS = (
    ...
    "rapidsms_tut.myhandlers.HelpHandler",
    "voting.handlers.ResultsHandler",
    "voting.handlers.VoteHandler"
    #'rapidsms.contrib.echo.handlers.ping.PingHandler',
)
#DEFAULT_RESPONSE = "We didn't get you. Try again"
